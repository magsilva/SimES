...
public class SopFileManipulator {
  ...
  private Hashtable startStateObjsToImages; // maps SimSEObjects from
                                            // CreatedObjects to filename of
                                            // associated image file (String)
  private Hashtable ruleObjsToImages; // maps SimSEObjects from
              ...
              } else // has image
              {
                SimSEObjectType tempObjType = objectTypes
                    .getObjectType(SimSEObjectTypeTypes
                        .getIntRepresentation(ssObjTypeTypeName), ssObjTypeName);
                ...
                } else // object type found
                {
                  ...
                  else if (keyAtt.getType() == AttributeTypes.DOUBLE) // double
                                                                      // attribute
                  {
                    try {
                  ...
                  else if (keyAtt.getType() == AttributeTypes.BOOLEAN) // boolean
                                                                       // attribute
                  {
                  ...
                  else if (keyAtt.getType() == AttributeTypes.STRING) // string
                                                                      // attribute
                  {
                    // try to get the object from created objects:
                    SimSEObject tempObj = objects.getObject(
