...
public class RandomActionTypeDestroyer extends ActionTypeDestroyer implements Cloneable
{
	private double frequency; // the frequency per clock tick of this action being destroyed when all of the destroyer conditions are met
