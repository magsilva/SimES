...
public class ActionTypeParticipantDestroyer implements Cloneable
{
	...
	public ActionTypeParticipantDestroyer(ActionTypeParticipant part)
	{
		participant = part;
	...
	public Object clone()
	{
		try
		{
			ActionTypeParticipantDestroyer cl = (ActionTypeParticipantDestroyer)(super.clone());
	...
	public ActionTypeParticipantConstraint getConstraint(String typeName) // note to self:
	...
	public void removeConstraint(String typeName) // removes the constraint for the SimSEObjectType with the specified
		// name; note to self:
		// it's okay to just give the type name and not the SimSEObjectTypeType because all SimSEObjectTypes in one participant MUST be of
		// the same SimSEObjectTypeType! Think about it!
	{
