...
public class UserActionTypeDestroyer extends ActionTypeDestroyer implements Cloneable
{
	private String menuText; // what should appear on a user's menu for destroying this action
