...
{
	private Attribute attribute; // POINTER TO the attribute that is being constrained
	private String guard; // guard on the value (defined by AttributeGuard class)
	private Object value; // value
	private boolean score; // whether or not this attribute defines the score for a game

	public ActionTypeParticipantAttributeConstraint(Attribute a, String g, Object val, boolean s)
	{
		attribute = a;
		guard = g;
		val = value;
	...
	public Object clone()
	{
		try
		{
			ActionTypeParticipantAttributeConstraint cl = (ActionTypeParticipantAttributeConstraint)(super.clone());
	...
	public boolean isConstrained() // returns true if there is a constraint for this attribute, false otherwise
	{
