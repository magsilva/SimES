...
{
	private int quantityGuard; // at least, at most, exactly, etc. (defined by Guard class)
	private Integer[] quantity; // actual numerical quantity (can have up to 2 numbers in it, for at least/at most guard)
	...
	public Object clone()
	{
		try
		{
			ActionTypeParticipantQuantity cl = (ActionTypeParticipantQuantity)(super.clone());
	...
	public int getGuard() // returns the quantity guard for this action type participant quantity
	{
		return quantityGuard;
	}


	public Integer[] getQuantity() // returns the quantity for this participant quantity
	{
		return quantity;
	}
	...
	{
		if(((quantityGuard == Guard.EXACTLY) && (quantity[0] != null)) || ((quantityGuard == Guard.AT_MOST) && (quantity[0] != null))
