...
public class StartStateAttributeTableModel extends AbstractTableModel {
  ...
  SimSEObject object; // SimSEObject in focus, whose attributes are being
  ...
  public void setObjectInFocus(SimSEObject obj) // sets the table to display the
      ...
      if (attributes != null) {
        ...
        for (int i = 0; i < attributes.size(); i++) {
          InstantiatedAttribute tempAtt = object
              .getAttribute(((Attribute) (attributes.elementAt(i))).getName());
          ...
          } else // tempAtt != null
          {
            ...
            if (tempVal != null) {
              temp.add(object.getAttribute(
                  ((Attribute) (attributes.elementAt(i))).getName()).getValue()
                  .toString());
            } else {
              temp.add("");
            }
