/* This class represents a generic instantiated attribute of a SimSE object.  It simply consists of an Attribute and an additional 
	field: value */
...
public class InstantiatedAttribute implements Cloneable //extends Attribute
{
	...
	public boolean isInstantiated() // returns true if this attribute has a value, false otherwise
	{
		if(value != null)
		{
			return true;
