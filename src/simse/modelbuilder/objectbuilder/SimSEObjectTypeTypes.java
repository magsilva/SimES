...
public class SimSEObjectTypeTypes
{
	...
	public static String getText(int objType) // returns the text corresponding to the object type
	{
		switch(objType)
		{
			case EMPLOYEE:
	...
	public static int getIntRepresentation(String objType) // returns the integer corresponding to the object type
	{
