...
public class AttributeTypes
{
	...
	public static String getText(int attrType) // returns the text corresponding to the attribute type
	{
		switch(attrType)
		{
			case STRING:
	...
	public static int getIntRepresentation(String attrType) // returns the integer corresponding to the attribute type
	{
