/* This class defines the model for the attribute table used in the ObjectBuilderGUI */
...
public class ObjectBuilderAttributeTableModel extends AbstractTableModel
{
	...
	SimSEObjectType object; // SimSEObjectType in focus, whose attributes are being displayed in the table
	String[] columnNames = {"Name", "Type", "Visible?", "Min Value", "Max Value", "Key?", "Visible At End?", "Min Digits", "Max Digits"}; 
		// column names
	...
	public void setObjectInFocus(SimSEObjectType obj) // sets the table to display the attributes of the obj parameter
	{
		object = obj;
		refreshData();
	}
	...
	public SimSEObjectType getObjectInFocus() // returns the object currently in focus
	{
		return object;
	}
