...
public abstract class Attribute implements Cloneable
{
	...
	private boolean visible; // whether or not this attribute should be visible to the player of the simulation
	private boolean key; // whether or not this attribute is the key for this object type -- i.e., must be unique
	private boolean visibleOnCompletion; // whether or not this attribute should be visible to the player at the end of the game
