/* This class defines the window through which destroyer rules can be put in order for priority of execution*/
...
public class DestroyerRulePrioritizer extends JDialog implements ActionListener
{
	private ActionType action; // action type whose Destroyer rules are being prioritized
	...
	public DestroyerRulePrioritizer(JFrame owner, ActionType act)
	{
		...
		Vector rules = action.getAllDestroyerRules();
