...
public class RuleInput implements Cloneable
{
	...
	private String prompt; // text that is shown when the user is prompted to enter this input
	private RuleInputCondition condition; // condition for acceptable input for this input
	private boolean cancelable; // whether or not this input can be cancelled by the player
	...
	public void clearCondition() // clears the condition value and sets its guard to the default, RuleInputGuard.LESS_THAN
	{
