/* This class defines the intial GUI for viewing/editing destroy objects rules with */
...
public class DestroyObjectsRuleInfoForm extends JDialog implements ActionListener
{
	...
	public DestroyObjectsRuleInfoForm(JFrame owner, DestroyObjectsRule rule, ActionType act, DefinedActionTypes acts, boolean newOrEdit)
	{
		super(owner, true);
		newRule = newOrEdit;
		actualRule = rule;
		...
		{
			ruleInFocus = (DestroyObjectsRule)(actualRule.clone()); // make a copy of the rule for editing
		}
		else // new rule
		{
			ruleInFocus = rule;
	...
	public void actionPerformed(ActionEvent evt) // handles user actions
	{
		...
		if(source == viewEditButton)
		{
			if(participantList.isSelectionEmpty() == false) // a participant is selected
			{
				...
				DestroyObjectsRuleParticipantConditionInfoForm condsForm =
					new DestroyObjectsRuleParticipantConditionInfoForm(this, 
					ruleInFocus.getParticipantCondition((String)(participantList.getSelectedValue())));
			}
		}
