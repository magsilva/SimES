	...
	*/
	...
	public void generate()
	{
		try
		{
			...
			writer.write("/* File generated by: simse.codegenerator.logicgenerator.dialoggenerator.ChooseActionToJoinDialogGenerator */");
			...
			// constructor:
			writer.write("public ChooseActionToJoinDialog(JFrame owner, Vector acts, Employee e, State s, String menText, RuleExecutor re)");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write("ChooseRoleToPlayDialog crtpd = new ChooseRoleToPlayDialog(gui, participantNames, emp, tempAct, menuText, ruleExec);");
			writer.write(NEWLINE);
			writer.write("setVisible(false);");
			writer.write(NEWLINE);
			writer.write("dispose();");
			...
			writer.write("ChooseRoleToPlayDialog crtpd = new ChooseRoleToPlayDialog(owner, participantNames, emp, tempAct, menuText, ruleExec);");
			writer.write(NEWLINE);
			writer.write("dispose();");
			writer.write(NEWLINE);
			writer.write("break;");
