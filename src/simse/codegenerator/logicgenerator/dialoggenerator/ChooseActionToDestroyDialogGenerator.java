	...
	*/
	...
	public void generate()
	{
		try
		{
			...
			writer.write("/* File generated by: simse.codegenerator.logicgenerator.dialoggenerator.ChooseActionToDestroyDialogGenerator */");
			...
			for(int j=0; j<userDestActs.size(); j++)
			{
				...
				for(int k=0; k<parts.size(); k++)
				{
					...
					for(int m=0; m<ssObjTypes.size(); m++)
					{
						...
						writer.write(OPEN_BRACK);
						writer.write(NEWLINE);
						writer.write("label.append(\"" + getUpperCaseLeading(tempType.getName()) + "(\" + ((" + getUpperCaseLeading(tempType.getName()) + ")a).get"
