	...
	*/
	...
	public void generate()
	{
		try
		{
			...
			writer.write("/* File generated by: simse.codegenerator.logicgenerator.TriggerCheckerGenerator */");
			...
			for(int j=0; j<triggers.size(); j++)
			{
				...
				for(int k=0; k<constraints.size(); k++)
				{
					...
					for(int m=0; m<attConstraints.length; m++)
					{
						...
						{
							writer.write(" && (a.get" + getUpperCaseLeading(attConst.getAttribute().getName()) + "() ");
