/* This class is responsible for generating all of the code for the World class for the GUI */
...
public class WorldGenerator
{
	...
	public void generate()
	{
		...
		try
		{
			...
			writer.write("/* File generated by: simse.codegenerator.guigenerator.WorldGenerator */");
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("public class World extends SimSEMap implements KeyListener, MouseListener, ActionListener");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("private boolean overheadTextDisplayed; // whether or not there is overhead text to display");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// how much to shift the map when a resize of the screen occurs:");
			writer.write(NEWLINE);
			...
			writer.write("public boolean overheadTextDisplayed() // returns true if there is overhead text displayed, false otherwise");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			*/
			...
			writer.write(NEWLINE);
			writer.write("dbGraphics.fillRect (0, 0, getSize().width, getSize().height);");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("if (employeeGone) // employee is about to disappear, need to sleep thread so the user can see their overhead text before they disappear");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("try");
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("xspacer = (width - MapData.X_MAPSIZE *MapData.TILE_SIZE ) / 2;");
			writer.write(NEWLINE);
			writer.write("yspacer = (height - MapData.Y_MAPSIZE *MapData.TILE_SIZE ) / 2;");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("g.drawImage(mapRep[j][i].getBase(), xspacer + j * MapData.TILE_SIZE, yspacer + i * MapData.TILE_SIZE, this);");
			writer.write(NEWLINE);
			writer.write("g.drawImage(mapRep[j][i].getFringe(), xspacer + j * MapData.TILE_SIZE, yspacer + i * MapData.TILE_SIZE, this);");
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("DisplayedEmployee tmp = (DisplayedEmployee)sopUsers.get(i);");
			writer.write(NEWLINE);
			writer.write("if(tmp.isDisplayed() && tmp.isActivated())");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("g.drawImage(tmp.getUserIcon(), xspacer + tmp.getXLocation() * MapData.TILE_SIZE, yspacer + tmp.getYLocation() * MapData.TILE_SIZE, this);");
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// go through all employees and display their overhead text, if any:");
			writer.write(NEWLINE);
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("DisplayedEmployee tempEmp = (DisplayedEmployee)sopUsers.get(i);");
			writer.write(NEWLINE);
			writer.write("String overheadText = tempEmp.getEmployee().getOverheadText();");
			writer.write(NEWLINE);
			writer.write("if((overheadText != null) && (overheadText.length() > 0)) // employee has overhead text");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("numOverheadTexts++;");
			writer.write(NEWLINE);
			writer.write("drawText(overheadText, tempEmp.getXLocation(), tempEmp.getYLocation(), g);");
			writer.write(NEWLINE);
			writer.write("if(state.getEmployeeStateRepository().getAll().contains(tempEmp.getEmployee()) == false) // employee is about to disappear");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// go through sop users and make sure that they are still in the state (haven't been destroyed):");
			writer.write(NEWLINE);
			writer.write("for(int i=0; i<oldSopUsers.size(); i++)");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("DisplayedEmployee tempDisEmp = (DisplayedEmployee)oldSopUsers.get(i);");
			writer.write(NEWLINE);
			writer.write("if(state.getEmployeeStateRepository().getAll().contains(tempDisEmp.getEmployee())) // employee is still there");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("if(sopUsers.size() < state.getEmployeeStateRepository().getAll().size()) // new emps have been added");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("DisplayedEmployee tempDisEmp = (DisplayedEmployee)sopUsers.get(j);");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("DisplayedEmployee newDisEmp = new DisplayedEmployee(tempEmp, getImage(tempEmp), this, true, true, getXYCoordinates(tempEmp)[0], getXYCoordinates(tempEmp)[1]);");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("// int xLoc - x coordinate of the employee to be drawn. -> UserData.xLocation");
			writer.write(NEWLINE);
			writer.write("// int yLoc - y coordinate of the employee to be drawn. -> UserData.yLocation");
			writer.write(NEWLINE);
			writer.write("// Graphics g - use the graphics object from the paintComponent(Graphics g)");
			writer.write(NEWLINE);
			writer.write("public void drawText(String s, int xLoc, int yLoc, Graphics g)");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// variables for starting x, starting y, width w, height h:");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// if string is longer than <lengthofOneLine> characters, break it into several lines");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("tmpW = f.stringWidth(temp) + 4; // offset of 4 for spacing purposes");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("strList.add(s);		// append either the whole string or the rest of the string");
			writer.write(NEWLINE);
			writer.write("scount++;");
			writer.write(NEWLINE);
			writer.write("String[] strings = (String[])strList.toArray(new String[1]);");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("h = h + (12 * (scount - 1)); // modify the box to match the string");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// this checks to determine where you can draw makes sure the speech bubble");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("else if (xLoc > xViewable - 3) // may change to visible width of the screen");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("if (yLoc > yViewable - 2) // may change to visible height of the screen");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// if x is free check if the bubble may conflict with anyone");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// yOffset may be either top or bottom depending on above if/else block");
			writer.write(NEWLINE);
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("// if a conflict occurs here, it can't be on the right side either");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// doesn't conflict on left side, no need to check other half if y is free");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("// if x is still free after above check, it means top left and top right");
			writer.write(NEWLINE);
			writer.write("// are blocked so on checks left are bottom left and bottom right");
			writer.write(NEWLINE);
			writer.write("if (x == FREE)");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			...
			writer.write(CLOSED_BRACK);
			writer.write(NEWLINE);
			writer.write("else // both x and y are free, so it's either bottom left or bottom right");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("boolean rconflict = false;");
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("// space similar to a carriage return add 1 for first line");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("clickedY = (me.getY() - yspacer - clickedHeightModifier)/MapData.TILE_SIZE;");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			...
			writer.write("DisplayedEmployee tmp = (DisplayedEmployee)sopUsers.get(i);");
			writer.write(NEWLINE);
			writer.write("if(tmp.checkXYLocations(clickedX,clickedY) && tmp.isActivated())");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("mainGUIFrame.getTabPanel().setObjectInFocus(tmp.getEmployee());");
			writer.write(NEWLINE);
			writer.write("mainGUIFrame.getAttributePanel().setGUIChanged();");
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("mainGUIFrame.getAttributePanel().setObjectInFocus(tmp.getEmployee(), new ImageIcon(tmp.getUserIcon()));");
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
			...
			writer.write(NEWLINE);
			writer.write(NEWLINE);
			writer.write("else if(state.getClock().isStopped() == false) // clock not stopped, and not left button click");
			writer.write(NEWLINE);
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("logic.getMenuInputManager().menuItemSelected(selectedUser.getEmployee(), item.getText(), mainGUIFrame);");
			writer.write(NEWLINE);
			writer.write("update();");
			writer.write(NEWLINE);
			writer.write(CLOSED_BRACK);
		...
		{
			JOptionPane.showMessageDialog(null, ("Error writing file " + worldFile.getPath() + ": " + e.toString()), "File IO Error",
