	...
	*/
	...
	public void generate()
	{
		...
		try
		{
			...
			writer.write("/* File generated by: simse.codegenerator.guigenerator.LogoPanelGenerator */");
			...
			writer.write(NEWLINE);
			writer.write("GridBagConstraints gbc = new GridBagConstraints(0,0,1,5,0,0,GridBagConstraints.WEST,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0);");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("gbc = new GridBagConstraints(0,0,1,1,1,1,GridBagConstraints.NORTHWEST,GridBagConstraints.NONE,new Insets(0,0,5,0),0,0);");
			writer.write(NEWLINE);
			...
			writer.write(NEWLINE);
			writer.write("gbc = new GridBagConstraints(0,1,1,1,1,0,GridBagConstraints.SOUTHWEST,GridBagConstraints.NONE,new Insets(5,0,0,0),0,0);");
			writer.write(NEWLINE);
			...
			writer.write(OPEN_BRACK);
			writer.write(NEWLINE);
			writer.write("GridBagConstraints gbc = new GridBagConstraints(x,y,rowspan,colspan,wx,wy,GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(1,1,1,1),0,0);");
			writer.write(NEWLINE);
		    ...
		    writer.write(OPEN_BRACK);
		    writer.write(NEWLINE);		    
		    writer.write("int response = JOptionPane.showConfirmDialog(gui,\"Are You Sure You Want To Reset?\",\"Reset Game?\",JOptionPane.YES_NO_OPTION);");
		    writer.write(NEWLINE);
