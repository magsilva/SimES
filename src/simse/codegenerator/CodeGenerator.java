...
writer.write(NEWLINE);
		...
		{
			JOptionPane.showMessageDialog(null, ("Error writing file " + ssFile.getPath() + ": " + e.toString()), "File IO Error",
		...
		engineGen.generate();
		guiGen.generate();
		JOptionPane.showMessageDialog(null, "Simulation generated!", "Generation Successful",
