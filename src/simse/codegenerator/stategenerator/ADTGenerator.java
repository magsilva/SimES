...
public class ADTGenerator implements CodeGeneratorConstants {
  ...
  public void generate() {
    ...
    File objClass = new File(options.getCodeGenerationDestinationDirectory(),
        ("simse" + File.separator + "adts" + File.separator + "objects" + File.separator + "SSObject.java"));
    if (objClass.exists()) {
    ...
    File empClass = new File(options.getCodeGenerationDestinationDirectory(),
        ("simse" + File.separator + "adts" + File.separator + "objects" + File.separator + "Employee.java"));
    if (empClass.exists()) {
    ...
    File custClass = new File(options.getCodeGenerationDestinationDirectory(),
        ("simse" + File.separator + "adts" + File.separator + "objects" + File.separator + "Customer.java"));
    if (custClass.exists()) {
    ...
    File actClass = new File(options.getCodeGenerationDestinationDirectory(), 
        ("simse" + File.separator + "adts" + File.separator + "actions" + File.separator + "Action.java"));
    if (actClass.exists()) {
  ...
  private void generateAbstractObjectClass(String className) {
    File absClass = new File(options.getCodeGenerationDestinationDirectory(),
        ("simse" + File.separator + "adts" + File.separator + "objects" + File.separator + className + ".java"));
    if (absClass.exists()) {
  ...
  private void generateObjectADT(SimSEObjectType objType) {
    File adtFile = new File(options.getCodeGenerationDestinationDirectory(), 
        ("simse" + File.separator + "adts" + File.separator + "objects" + File.separator + CodeGeneratorUtils.getUpperCaseLeading(
  ...
  private void generateActionADT(ActionType actType) {
    File adtFile = new File(options.getCodeGenerationDestinationDirectory(), 
        ("simse" + File.separator + "adts" + File.separator + "actions" + File.separator +  CodeGeneratorUtils.getUpperCaseLeading(
